...
class DXMonitor_Window(QDialog, DXMonitor_UI):
    ...
    def scan_local_stations(self):
        ...
        self.tuner_timer.start(int(self.WAIT_TIME*1000))
    ...
    def start_frequency_monitor(self):
        ...
        self.monitor_timer.start(int(self.WAIT_TIME*1000))
...
class MainApp(QMainWindow,MainApp_UI):
    ...
    def __init__(self):
        ...
        self.Volume_Dial.setMinimum(-60)
        self.Volume_Dial.setMaximum(24)
...
class TunerWorker(QObject):
    ...
    def toggle_signal_monitor(self):
        ...
        if self.__MONITOR_SIGNAL__ == False:
            ...
            self.signal_timer.start(int(self.__REFRESH_SIGNAL_INTERVAL__))
